...
export const websiteData = {
  ...
  "sample-website-7": {
    ...
    title: "RM Club – Multi-Venture Business Ecosystem",

    info: "A corporate ecosystem website for RM Club, designed to showcase its portfolio of ventures across construction, hospitality, retail, travel, media, finance and education while communicating the group's long-term vision, leadership and multi-sector growth strategy.",

    areas: "Corporate Website & Multi-Venture Ecosystem",

    liveLink: "https://rmclub.co/",

    liveLinkDisplay: "rmclub.co",
    ...
    renderShowcase: () => (
      <div className="w-full max-w-[760px] aspect-[16/10] relative overflow-hidden bg-zinc-950 rounded-none shadow-[0_25px_70px_-15px_rgba(0,0,0,0.2)] flex items-center justify-center">
        <Image
          ...
          alt="RM Club Multi-Venture Business Ecosystem Website Showcase"
          fill
          className="object-cover object-top"
          priority
        />
