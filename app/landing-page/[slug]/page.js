      ...
      <section className="w-full px-6 sm:px-10 lg:px-16 flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-12 mt-12 sm:mt-16 lg:mt-24 mb-6">
        ...
        <div className="w-full lg:w-[42%] flex flex-col justify-between flex-shrink-0 min-w-0 pt-0">
          <div className="space-y-8 sm:space-y-10">
            ...
            <div className="grid grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] gap-4 sm:grid-cols-2 sm:gap-8">
              ...
              <div className="min-w-0 space-y-1.5">
                ...
                <a
                  ...
                  className="min-w-0   text-xs sm:text-sm lg:text-base text-zinc-950 font-medium hover:text-zinc-500 transition-colors inline-flex items-start gap-1.5 group"
                >
